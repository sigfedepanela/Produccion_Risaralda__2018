...
var style_ProduccindePanelaToneladas_2 = function(feature, resolution){
    ...
    if (value >= 236.460000 && value <= 236.460000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 236.460000 && value <= 603.220000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 603.220000 && value <= 902.420000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 902.420000 && value <= 4825.750000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 4825.750000 && value <= 5539.960000) {
            style = [ new ol.style.Style({
